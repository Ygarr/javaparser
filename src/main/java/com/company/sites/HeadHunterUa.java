...
import com.company.parser.siteparsers.HeadHunterUaJobParser;
...
public class HeadHunterUa implements JobSite {
   ...
   // private static final String SITE_URL = "https://hh.ua/search/vacancy?text=java&area=115";
    private static final String SITE_URL = "https://hh.ua/search/vacancy?text=java&enable_snippets=true&currency_code=UAH&clusters=true&area=2185&from=cluster_area";
